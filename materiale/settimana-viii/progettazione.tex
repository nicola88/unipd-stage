...
\begin{document}
	...
	La classe \textit{\nameref{sec:stage:design:model:metadata-emotion}} rappresenta un'emozione associabile ad un contenuto ed estende la classe \textit{\nameref{sec:stage:design:model:metadata}}.

	\subsection[Intention]{Intention | Intenzione}
	\label{sec:stage:design:model:metadata-intention}
	La classe \textit{\nameref{sec:stage:design:model:metadata-intention}} rappresenta un'intenzione associabile ad un contenuto ed estende la classe \textit{\nameref{sec:stage:design:model:metadata}}.

	\subsection[Interest]{Interest | Interesse}
	\label{sec:stage:design:model:metadata-interest}
	La classe \textit{\nameref{sec:stage:design:model:metadata-interest}} rappresenta gli interessi cui è associabile un contenuto ed estende la classe \textit{\nameref{sec:stage:design:model:metadata}}.

	\subsection[Topic]{Topic | Argomento}
	\label{sec:stage:design:model:metadata-topic}
	La classe \textit{\nameref{sec:stage:design:model:metadata-topic}} rappresenta un argomento cui può appartenere un contenuto ed estende la classe \textit{\nameref{sec:stage:design:model:metadata}}.
	...
	La classe \textit{\nameref{sec:stage:design:model:metadata-user}} rappresenta l'utente che ha pubblicato il contenuto ed estende la classe \textit{\nameref{sec:stage:design:model:metadata}}.
	...
	La classe \textit{\nameref{sec:stage:design:model.criteria:switch-criterion}} rappresenta un criterio di classificazione che l'utente può semplicemente decidere di attivare o disattivare.
	...
	La classe \textit{\nameref{sec:stage:design:model.criteria:emotion}} rappresenta un criterio di classificazione a lista di valori basato sulle emozioni.

	\subsection[CLIntention]{CLIntention | Intenzione}
	\label{sec:stage:design:model.criteria:intention}
	La classe \textit{\nameref{sec:stage:design:model.criteria:intention}} rappresenta un criterio di classificazione a lista di valori basato sulle intenzioni..

	\subsection[CLTopic]{CLTopic | Argomento}
	\label{sec:stage:design:model.criteria:topic}
	La classe \textit{\nameref{sec:stage:design:model.criteria:topic}} rappresenta un criterio di classificazione a lista di valori basato sugli argomenti.

	\subsection[CLType]{CLType | Tipo di contenuto}
	\label{sec:stage:design:model.criteria:type}
	La classe \textit{\nameref{sec:stage:design:model.criteria:type}} rappresenta un criterio di classificazione a lista di valori basato sui tipi di contenuto.

	\subsection[CLUser]{CLUser | Utente}
	\label{sec:stage:design:model.criteria:user}
	La classe \textit{\nameref{sec:stage:design:model.criteria:user}} rappresenta un criterio di classificazione a lista di valori basato sugli autori dei contenuti.

	\subsection[CRDate]{CRDate | Data di pubblicazione}
	\label{sec:stage:design:model.criteria:publication-date}
	La classe \textit{\nameref{sec:stage:design:model.criteria:publication-date}} rappresenta un criterio di classificazione ad intervallo di valori basato sulla data di pubblicazione.
	% Specifica la data minima e massima di pubblicazione tra i contenuti corrispondenti ai criteri di ricerca (\textit{\nameref{sec:stage:design:model.search:search-result}}) e l'unità temporale predefinita.

	\subsection[CSInterest]{CSInterest | Interessi dell'utente}
	\label{sec:stage:design:model.criteria:interest}
	La classe \textit{\nameref{sec:stage:design:model.criteria:interest}} rappresenta un criterio di classificazione ad interruttore basato sugli interessi dell'utente.

	\subsection[CVRating]{CVRating | Giudizio}
	\label{sec:stage:design:model.criteria:rating}
	La classe \textit{\nameref{sec:stage:design:model.criteria:rating}} rappresenta un criterio di classificazione a soglia di valore basato sui giudizi espressi dagli utenti sui contenuti.

	\subsection[CVRelevance]{CVRelevance | Attinenza}
	\label{sec:stage:design:model.criteria:relevance}
	La classe \textit{\nameref{sec:stage:design:model.criteria:relevance}} rappresenta un criterio di classificazione a soglia di valore basato sulla rilevanza dei contenuti rispetto ai criteri di ricerca immessi.
